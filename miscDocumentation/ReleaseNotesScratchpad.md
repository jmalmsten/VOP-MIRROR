...
It's built with two modes. Both are highly experimental and I have yet to get good results from them. 
#### DRE
This does the Dynamic Range Expansion through a single exposure. Animating the brightness levels throughout.
#### BRK
This does it the more classic way. With several Bracketed exposures. 
### Calibration Page
