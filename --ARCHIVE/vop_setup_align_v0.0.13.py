...
Version:        v0.0.13
Description:    TCP 'Call-Home' Alignment Utility.
                Pi connects TO Desktop to bypass routing silences.
"""
...
def start_stream():
    ...
    # Pi connects to Desktop. baseline/zerolatency tuning for sub-second lag.
    cmd = [
        "sudo", "rpicam-vid", "-t", "0", "--inline", "--width", "1280", "--height", "720",
        "--framerate", "30", "--codec", "h264", "--profile", "baseline", 
        "--flush", "--tune", "zerolatency",
