"""
VOP Module:     vop_setup_align_v0.0.6.py
Version:        v0.0.6
Description:    TCP-Based Alignment Utility.
                Solves the UDP silent-drop issue on Fedora.
"""
...
def start_stream():
    # TCP Listen mode: Pi waits for connection. 
    # Profile 'baseline' and 'tune zerolatency' are key.
    cmd = [
...
def run():
    ...
    print(f"✅ TCP SERVER LIVE ON {PI_IP}:5000. Connect from Desktop.")
    running = True
    while running:
