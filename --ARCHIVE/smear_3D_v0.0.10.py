"""
VOP Module:     smear_3D_10.py
Version:        v0.0.10
Description:    Final 3D Proof for Pi 5 GLES 3.1.
                - Far clipping plane extended to 1000.0.
                - Mouse cursor hidden.
                - Optimized for Flask integration.
"""
import os
import sys
...
def run_vop_3d(args):
    ...
    pygame.init()
    pygame.mouse.set_visible(False) # Hide the cursor for v0.0.10
    ...
    try:
        ...
        while True:
            ...
            # Extended far plane to 1000.0
            proj = Matrix44.perspective_projection(args.fov, WIDTH/HEIGHT, 0.1, 1000.0)
