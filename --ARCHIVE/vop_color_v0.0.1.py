"""
VOP Module:         vop_color_v0.0.1.py
Version:            v0.0.1
Description:        Phase III: Projection Color with Perceptual Color Math
                    This file tries to emulate the effect of putting a 
                    color gel between the projection light source and
                    the image being projected. 
                    Handles Oklab conversions to ensure even brightness
                    during chromatic smears.
"""
